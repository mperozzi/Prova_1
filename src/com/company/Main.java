...
public class Main {
	...
	Tabella t = new Tabella();
		...
		t.overwrite_attribute_from_list(3, "Ciccia");  //sovrascrivo un attributo di un oggetto alla riga 3 della tabella
		System.out.println("Stampo la tabella sovrascritta");
		t.print_tab(size);
		System.out.println();

		t.insert_tab(size, 2);  //inserimento di altri due oggetti all'interno della tabella
